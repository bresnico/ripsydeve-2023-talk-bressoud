...
Influencée par le développement des **interdépendances positives** ([Buchs et al., 2012](https://www.researchgate.net/publication/236344967_Cooperation_et_apprentissage/citation/download) ; [Johnson et Johnson, 1989](https://psycnet.apa.org/record/1989-98552-000)) et du **pouvoir d'agir** ([Bressoud & Gay, 2022)](https://ojs.szh.ch/revue/article/view/1062) ; [Ryan et Deci, 2000](https://psycnet.apa.org/record/2000-13324-007))
...
- (Intercept) : β₀ = 5.5014, SE = 0.1137, t(347) = 48.367, p < .001 ***
- group : β₁ = -0.4467, SE = 0.1492, t(347) = -2.994, p = .00295 **
- time2 : β₂ = -0.2468, SE = 0.1649, t(347) = -1.496, p = .13544
- group:time2 : β₃ = 0.2472, SE = 0.2142, t(347) = 1.154, p = .24920
...
- (Intercept) : β₀ = 4.17067, SE = 0.07493, t(347) = 55.662, p < .001 ***
- group : β₁ = 0.07404, SE = 0.09830, t(347) = 0.753, p = .452
- time2 : β₂ = -0.04125, SE = 0.10866, t(347) = -0.380, p = .704
- group:time2 : β₃ = 0.15472, SE = 0.14108, t(347) = 1.097, p = .274
