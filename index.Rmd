...
- Satisfaction professionnelle des profs [(d'après Diener et al., 1985)](https://psycnet.apa.org/record/1985-27000-001)
...
| Groupe       | N   | Années d'exp. moyen (SD)| Genre (Hommes/Femmes) | 
|--------------|-----|-------------------------|-----------------------|
...
```{r, echo=FALSE, out.width="50%", fig.align="center", fig.cap="image d'illustration"}
